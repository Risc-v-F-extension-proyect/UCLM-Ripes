...
#define RIPES_SETTING_CACHE_MAXTRACES ("cache_maxtraces")
...
#define RIPES_SETTING_RV5S_FALU_ADDSUB_LATENCY ("rv5s_falu_addsub_latency")
#define RIPES_SETTING_RV5S_FALU_MUL_LATENCY ("rv5s_falu_mul_latency")
#define RIPES_SETTING_RV5S_FALU_DIV_LATENCY ("rv5s_falu_div_latency")
#define RIPES_SETTING_RV5S_FALU_ADDSUB_COUNT ("rv5s_falu_addsub_count")
#define RIPES_SETTING_RV5S_FALU_MUL_COUNT ("rv5s_falu_mul_count")
#define RIPES_SETTING_RV5S_FALU_DIV_COUNT ("rv5s_falu_div_count")
#define RIPES_SETTING_RV5S_FALU_ADDSUB_PIPELINED ("rv5s_falu_addsub_pipelined")
#define RIPES_SETTING_RV5S_FALU_MUL_PIPELINED ("rv5s_falu_mul_pipelined")
#define RIPES_SETTING_RV5S_FALU_DIV_PIPELINED ("rv5s_falu_div_pipelined")
