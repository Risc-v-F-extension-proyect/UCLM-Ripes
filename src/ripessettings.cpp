...
const std::map<QString, QVariant> s_defaultSettings = {
    ...
    {RIPES_SETTING_RV5S_FALU_ADDSUB_LATENCY, 4},
    {RIPES_SETTING_RV5S_FALU_MUL_LATENCY, 7},
    {RIPES_SETTING_RV5S_FALU_DIV_LATENCY, 25},
    {RIPES_SETTING_RV5S_FALU_ADDSUB_COUNT, 1},
    {RIPES_SETTING_RV5S_FALU_MUL_COUNT, 1},
    {RIPES_SETTING_RV5S_FALU_DIV_COUNT, 1},
    {RIPES_SETTING_RV5S_FALU_ADDSUB_PIPELINED, false},
    {RIPES_SETTING_RV5S_FALU_MUL_PIPELINED, false},
    {RIPES_SETTING_RV5S_FALU_DIV_PIPELINED, false},
