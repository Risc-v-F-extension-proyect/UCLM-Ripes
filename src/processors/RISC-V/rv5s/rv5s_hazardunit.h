...
public:
  ...
  Decision analyze(const IncomingInstruction &incoming) const {
    ...
    //ciclo en que la instrucción estará completa pero no necesariamente lista para salir
    result.completionCycle = currentCycle + incoming.latency;
    //ciclo en que la instrucción estará lista para salir de EX
