...
private:
  ...
  StallHistoryChart *m_stallHistoryChart = nullptr;
  QSpinBox *m_stallCycleSearch = nullptr;
  QSpinBox *m_statisticsRangeStart = nullptr;
  QSpinBox *m_statisticsRangeEnd = nullptr;
  bool m_statisticsRangeEnabled = false;
